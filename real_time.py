...
def planning(epsilon, graph_size, alpa, param):
    """
    ...
    while (datetime.datetime.now()-start).seconds<10:
        ...
        for route in routes:
            ...
            queries[index_tmp].dict1[indexs[index_tmp]]+=param*(reward-queries[index_tmp].dict1[indexs[index_tmp]])
            index_tmp+=1
